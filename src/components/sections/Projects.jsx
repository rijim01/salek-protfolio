      ...
      <RevealOnScroll>
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* ===== Project 1: Interactive Statistical Calculator ===== */}
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              <h3 className="text-xl font-bold mb-2">Interactive Statistical Calculator</h3>
              <p className="text-gray-400 mb-4">
                Developed using R Shiny. A tool for performing statistical calculations interactively.
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                {["R Shiny", "Statistics", "Data Analysis"].map((tech, key) => (
                  <span
                    key={key}
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://qa8m8h-md0salek-miah.shinyapps.io/calculator/"
                  target="_blank"
            ...
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              <h3 className="text-xl font-bold mb-2">MovieLens Recommendation System</h3>
              <p className="text-gray-400 mb-4">
                Developed an interactive movie recommendation application using R Studio and Hugging Face Spaces.
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                {["R Studio", "Machine Learning", "Hugging Face"].map((tech, key) => (
                  <span
                    key={key}
                    className="bg-blue-500/10 text-blue-500 py-1 px-3 rounded-full text-sm hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition"
                  >
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://huggingface.co/spaces/salekml/MovieLens_App1"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-blue-400 hover:text-blue-300 transition-colors my-4"
                >
